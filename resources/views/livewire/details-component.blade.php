			...
			<div class="row">
							...
							<div class="product-gallery">
							  <ul class="slides">
							    ...
							    <li data-thumb="{{ asset('assets/images/products/') }}/{{ $product->image }}">
							    	<img src="{{ asset('assets/images/products')}}/{{ $product->image }}" alt="{{ $product->name }}l" />
							    </li>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget widget-product">
						...
						<div class="widget-content">
							<ul class="products">
								{{-- {{ return array($related_products) }} --}}
								@foreach ($popular_products as $p_product)
								<li class="product-item">
									<div class="product product-widget-style">
										<div class="thumbnnail">
											{{-- Not Understanding -----8-8-8-88--8-8-8-8- --}}
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">${{ $p_product->price }}</span></div>
										</div>
									</div>
								</li> 
								@endforeach
